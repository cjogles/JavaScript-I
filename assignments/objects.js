...
class Parent {
  ...
  get personName() {
    return (`My name is ${this.objName}`);
  }
  get personAge() {
    return "My age is " + this.objAge;
  }

  speak() {
    return "Hello there I can speak! My name is " + this.objName;
  }
}

let parentObj = new Parent("Susan", 70);
// ****************************************************************************************************
...
let childObj = new Child("George", 50);
// ***************************************************************************
...
let grandchildObj = new Grandchild("Sam", 30);
// ***************************************************************************************************

// 4. Give each of the objects the ability to speak their names using the this keyword.

// Did it. See the getter in Parent class. ^^^


// *****************************************************************
// Log the parent object's name
console.log(parentObj.personName);
// Log the child's age
console.log(childObj.personAge);
// Log the name and age of the grandchild
console.log(grandchildObj.personName + " " + grandchildObj.personAge);
// Have the parent speak
console.log(parentObj.speak());
// Have the child speak
console.log(childObj.speak());
// Have the grandchild speak
console.log(grandchildObj.speak());
// *******************************************************************